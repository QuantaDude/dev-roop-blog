...
**Languages & Runtime:** TypeScript, C++, JavaScript, WASM, Node.js

**Frameworks & Data:** Nest.js, React, PostgreSQL, Redis, BullMQ&nbsp;&nbsp;&nbsp;**Tooling:** Vitest, AWS, Git, GitHub CI/CD

## Experience

### Open-Source Contributor, OpenEXR *— Academy Software Foundation*

DevDays 2026 | PR [#2647](https://github.com/AcademySoftwareFoundation/openexr/pull/2647) · [#2652](https://github.com/AcademySoftwareFoundation/openexr/pull/2652) · [#2649](https://github.com/AcademySoftwareFoundation/openexr/pull/2649) · [#2657](https://github.com/AcademySoftwareFoundation/openexr/pull/2657)

- Removed the `all.cpp` aggregation hack from the docs build: made each example compile standalone and switched to a CMake OBJECT library so missing headers fail in CI.
